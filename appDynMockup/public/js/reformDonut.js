...
function reformDonut(id, mljsonstr, prefix, idx) {
    ...
    var figure = {
        "data": [{
            ...
            "type": "pie",
            "values": [
                mljsonstr.homepage.slow_percent * mljsonstr.homepage.anomalous_percent,
                mljsonstr.homepage.very_slow_percent * mljsonstr.homepage.anomalous_percent,
                mljsonstr.homepage.error_percent * mljsonstr.homepage.anomalous_percent,
                1 - mljsonstr.homepage.anomalous_percent
            ]
        }, {
            ...
            "marker": {"colors": ["yellow", "orange", "red"]},
            "name": "Breakdown of Anomalous Transactions",
            "type": "pie",
            "values": [
                mljsonstr.homepage.slow_percent,
                mljsonstr.homepage.very_slow_percent,
            ...
            "annotations": [{
                ...
                "x": 0.8,
                "y": 0.5
            }, {"font": {"size": 12}, "showarrow": false, "text": "Total", "x": 0.2, "y": 0.5}
            ],
            "template": {
                "data": {
                    "bar": [{
            ...
            }, "title": {"text": "Anomalous Problem Groups"}
        }
    };
